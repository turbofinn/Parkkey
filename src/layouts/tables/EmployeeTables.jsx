...
function EmployeeTables() {
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('https://xkzd75f5kd.execute-api.ap-south-1.amazonaws.com/prod/user-management/vendor/fetch-all-employee/d7e4e25e-8bb2-480e-a807-5e5eb8342ce9', {
                headers: {
